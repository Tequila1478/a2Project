...
void AABacktrace_MazeGen::SpawnNavMeshForLevelAI(){
	if (HasAuthority()) {
...
void AABacktrace_MazeGen::BeginPlay()
{
	...
	//if (HasAuthority()) {
		...
		GetWorld()->GetTimerManager().SetTimer(DelayHandle, this, &AABacktrace_MazeGen::DelayedSpawnLogic, 0.1f, false);
...
void AABacktrace_MazeGen::DelayedSpawnLogic()
{
...
void AABacktrace_MazeGen::CreateRoomInfo() {
